...
taxa <- assignTaxonomy(seqtab.nochim, "/projects/ps-shurinlab/Databases/SILVA/silva_nr_v138_train_set.fa.gz", multithread=TRUE)

# to add in Species for 16S
taxa <- addSpecies(taxa, "/projects/ps-shurinlab/Databases/SILVA/silva_species_assignment_v138.fa.gz")
