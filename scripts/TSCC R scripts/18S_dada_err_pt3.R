...
#write.csv(filt_out, file="/projects/ps-shurinlab/users/cbwall/Yos_water_18S/output/filt_out.csv")
...
# not the files here are for 18S (version 1)
# the other Silva database 'silva_nr99_v138.1_train_set.fa.gz' is for 16S

taxa <- assignTaxonomy(seqtab.nochim, "/projects/ps-shurinlab/Databases/SILVA/18S_assignment/silva_nr_v138_train_set.fa.gz", multithread=TRUE)

# to add in Species for 16S
taxa <- addSpecies(taxa, "/projects/ps-shurinlab/Databases/SILVA/18S_assignment/silva_species_assignment_v138.fa.gz")
