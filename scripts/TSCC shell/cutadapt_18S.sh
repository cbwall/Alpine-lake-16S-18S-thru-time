...
#PBS -o /projects/ps-shurinlab/users/cbwall/Yos_water_18S/output/outs/cutadapt_out
#PBS -e /projects/ps-shurinlab/users/cbwall/Yos_water_18S/output/errs/cutadapt_err
#PBS -V
...
cd /projects/ps-shurinlab/Yos_water_DNA/18S_Yos_data/
...
ls /projects/ps-shurinlab/Yos_water_DNA/18S_Yos_data | sed 's/_L[[:digit:]]\+_.*//g' > /projects/ps-shurinlab/users/cbwall/Yos_water_18S/data/samples.txt
...
# for nucleotide codes (for degenerecy) https://www.bioinformatics.org/sms/iupac.html
...
cd /projects/ps-shurinlab/users/cbwall/Yos_water_18S/
...
do
    ...
    cutadapt -g CCAGCASCYGCGGTAATTCC -G ACTTTCGTTCTTGATYRA \
    -o data/trimmed/${SAMPLEID}_R1_trimmed.fastq \
    -p data/trimmed/${SAMPLEID}_R2_trimmed.fastq \
    projects/ps-shurinlab/Yos_water_DNA/18S_Yos_data//${SAMPLEID}_L001_R1_001.fastq \
    projects/ps-shurinlab/Yos_water_DNA/18S_Yos_data//${SAMPLEID}_L001_R2_001.fastq \
	>> output/cutadapt_primer_trimming_stats.txt 2>&1
done


# re-zip sequence files
gzip /projects/ps-shurinlab/Yos_water_DNA/18S_Yos_data/*.fastq
gzip /projects/ps-shurinlab/users/cbwall/Yos_water_18S/trimmed/*.fastq
